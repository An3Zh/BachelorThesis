...
The function should output \code{tf.data.Dataset} objects\footnote{\url{https://www.tensorflow.org/api_docs/python/tf/data/Dataset}} that are ready for immediate use in training pipelines.
