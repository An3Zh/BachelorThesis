...
Thunder Compute, an American startup providing \gls{gpu} cloud resources for machine learning and data science, was utilized for large-scale experiments \cite{thundercompute}.
